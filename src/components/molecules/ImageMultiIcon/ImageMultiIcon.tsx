        ...
        <div className="image-multi-icon">
            ...
            <div className='image-multi-icon__icon-container image-multi-icon__icon-container--visible-xl'>
                <div className='image-multi-icon__icon-text'>
                    <IconTextBar source={ios ? '/images/icons/BlueBell.svg' : '/images/icons/GreenBell.svg'} 
                                 text='Get Reminders' ios={ios}/> 
                </div>

                <div className='image-multi-icon__icon-text'>
                    <IconTextBar source={ios? '/images/icons/Arrows.svg' : '/images/icons/GreenArrows.svg'} 
                ...
                <div className='image-multi-icon__icon-text'>
                    <IconTextBar source={ios ? '/images/icons/Channel.svg' : '/images/icons/LinkGreen.svg'} 
                    text='The multichannel' 
                    emptyBar={true} 
                    ios={ios}/>
                </div>
            </div>
